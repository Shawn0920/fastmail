...
public final class RectFindView extends View {
    ...
    private String drawColor = "#9ff24a";
...
//                    "please_collect", "string", context.getPackageName())) + drawText, (int) (namePositionX * width), namePositionY * height, paint);
//        }
//        else if(dm.densityDpi==320)
//        {
//            canvas.drawText(context.getString(getResources().getIdentifier(
//                    "please_collect", "string", context.getPackageName())) + drawText, (int) (namePositionX * width*0.9), namePositionY * height, paint);
//        }else
//        {
//            paint.setTextSize(Float.valueOf(30));
//
//            canvas.drawText(context.getString(getResources().getIdentifier(
//                    "please_collect", "string", context.getPackageName())) + drawText, (int) (namePositionX * width*0.75), namePositionY * height, paint);
//        }
        if (frame == null) {
            return;
        }
