...
public class CameraSetting {
    ...
    WeakReference<SmartvisionCameraActivity> weakReference;
...
//                    parameters.setZoom((int) (camera.getParameters().getMaxZoom() * 0.1));
     ...
     * @param currentType
     * @param holder
     * @param smartvisionCameraActivity
     * @param vinCameraPreView
     */
    public void initCameraParamters(Camera camera, int currentType, SurfaceHolder holder, SmartvisionCameraActivity smartvisionCameraActivity, VinCameraPreView vinCameraPreView) {
        this.camera = camera;
        this.currentType = currentType;
        weakHolder = new WeakReference<SurfaceHolder>(holder);
        weakReference = new WeakReference<SmartvisionCameraActivity>(smartvisionCameraActivity);
